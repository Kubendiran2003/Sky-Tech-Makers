  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 bg-[#f4f6f8]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/3 w-80 h-80 bg-indigo-500/5 rounded-full blur-3xl" />
      ...
      >
        ...
        <h1 className="text-8xl font-black gradient-text-blue mb-4">404</h1>
