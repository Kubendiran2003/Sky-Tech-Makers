...
export default function SubmitQuestion() {
  ...
  const selectClass = "w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 transition-all duration-200 cursor-pointer [&>option]:bg-white [&>option]:text-slate-800 text-sm shadow-sm";
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-4">
            ...
            <span className="text-xs font-semibold text-indigo-400 uppercase tracking-wider">Help the Community</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900">Submit Interview Q&A</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <FiEdit3 className="absolute left-3.5 top-3 w-4 h-4 text-slate-400 pointer-events-none" />
                <textarea
                  name="question"
                  required
                  rows={3}
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 transition-all duration-200 resize-none shadow-sm"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <FiBookOpen className="absolute left-3.5 top-3 w-4 h-4 text-slate-400 pointer-events-none" />
                <textarea
                  name="answer"
                  required
                  rows={4}
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 text-sm focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 transition-all duration-200 scrollbar-thin resize-y shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <div className="relative">
                  <FiBriefcase className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none" />
                  <input
                    type="text"
                    name="company"
                    required
              ...
              <div>
                ...
                <div className="relative">
                  <FiActivity className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none" />
                  <select
                    name="difficulty"
                    required
